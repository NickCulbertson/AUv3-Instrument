//
//  InstrumentAUv3AudioUnit.m
//  InstrumentAUv3
//
//  Created by Nick Culbertson on 3/17/22.
//

#import "InstrumentAUv3AudioUnit.h"
...
@interface InstrumentAUv3AudioUnit ()
...
@implementation InstrumentAUv3AudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[InstrumentAUv3DSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block InstrumentAUv3DSPKernelAdapter * kernelAdapter = _kernelAdapter;
