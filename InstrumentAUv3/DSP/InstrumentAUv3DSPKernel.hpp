//
//  InstrumentAUv3DSPKernel.hpp
//  InstrumentAUv3
//
//  Created by Nick Culbertson on 3/17/22.
//

#ifndef InstrumentAUv3DSPKernel_hpp
#define InstrumentAUv3DSPKernel_hpp
...
/*
 InstrumentAUv3DSPKernel
 Performs simple copying of the input signal to the output.
 As a non-ObjC class, this is safe to use from render thread.
 */
class InstrumentAUv3DSPKernel : public DSPKernel {
public:
...
#endif /* InstrumentAUv3DSPKernel_hpp */
